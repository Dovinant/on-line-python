...
def create_network_map(filenames):
    ...
    result_right = {}
    result_left = {}
# Переменная key_delete содержит ключ той записи словаря, которую надо удалить
    key_delete = False
...
переменную key_delete и останавливаем поиск в словаре result_right, совпадение может быть только одно.
Сравнив строки в обоих словарях, удаляем запись из словаря result_left.

Удаляем найденную запись из result_left и добавляем этот словарь в result_right
'''
